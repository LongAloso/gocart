...
const AddressModal = ({ setShowAddressModal }) => {
    ...
    return (
        <form onSubmit={e => toast.promise(handleSubmit(e), { loading: 'Adding Address...' })} className="fixed inset-0 z-80 bg-white/60 backdrop-blur h-screen flex items-center justify-center">
